...
func Run(wg *sync.WaitGroup) {
	...
	router.Handle("/crawl_issues", isAuthorized(user_handler.CrawlIssueByVersion)).Methods("GET")
	router.Handle("/version_project", isAuthorized(user_handler.SetCurrentVersion)).Methods("POST")
